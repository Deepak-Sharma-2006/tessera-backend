...
public class ChatWebSocketController {
    ...
    public void sendMessage(@Payload ChatMessage chatMessage) {
        Chat chat = chatService.sendMessage(chatMessage.getChatId(), chatMessage.getSenderId(),
    ...
    // ✅ UPGRADED: Handle conversation messages with full 8-parameter support for
    // replies
    ...
    public void handleConversationMessage(@Payload Message message) {
        try {
            ...
            if (message.getReplyToId() != null) {
                ...
                System.out.println("   ReplyToSenderId: " + message.getReplyToSenderId()); // ✅ CRITICAL: Log the
                                                                                           // original sender ID
            ...
            Message saved = messagingService.sendMessage(
                    ...
                    message.getReplyToId(), // Reply ID
                    message.getReplyToContent(), // Reply content
                    message.getReplyToName(), // Reply sender name
                    message.getReplyToSenderId()); // ✅ CRITICAL: 8th parameter - sender ID of original message
    ...
    // ✅ UPGRADED: Broadcast typing indicators to conversation topic (NOT individual
    // user queue)
